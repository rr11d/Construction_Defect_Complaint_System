...
![사용자 민원 접수](media/user-report-create.png)

### 내 민원 조회

사용자가 접수한 민원 목록을 확인할 수 있습니다. 각 민원은 하자 내용을 요약한 제목과 처리 상태로 표시되며, 새 민원 접수 화면으로 바로 이동할 수 있습니다.

![내 민원 조회](media/user-report-list.png)

### 민원 상세 확인

접수한 민원을 펼쳐서 사진, 위치, 하자 부위, 긴급도, 사용자 설명, AI 분석 결과를 확인할 수 있습니다. 사진은 작은 갤러리로 표시하고, 클릭하면 큰 이미지로 확인할 수 있습니다.

![사용자 민원 상세](media/user-report-detail.png)
